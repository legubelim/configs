...
##### Put the right token! #####
echo "duplicati-cli backup dropbox://owncloud?authid=****************************************************** /mnt/SSD_externe/owncloud/data/files $INCLUDES --no-encryption --retention-policy='20Y:1Y,12M:1M'"
eval "duplicati-cli backup dropbox://owncloud?authid=****************************************************** /mnt/SSD_externe/owncloud/data/files $INCLUDES --no-encryption --retention-policy='20Y:1Y,12M:1M'"
