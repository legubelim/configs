...
#duplicati-cli backup /mnt/SSD2/backups/test_dropbox /mnt/SSD1/owncloud/data/files $INCLUDES --no-encryption --retention-policy='20Y:1Y,12M:1M'
...
eval "duplicati-cli backup dropbox://owncloud?authid=****************************************************** /mnt/SSD1/owncloud/data/files $INCLUDES --no-encryption --retention-policy='20Y:1Y,12M:1M'"
